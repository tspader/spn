...
static const defines_t defines_tests [] = {
  ...
  {
    .name = "gnu_linker",
    .facts = { .os = SPN_OS_LINUX, .arch = SPN_ARCH_X64, .abi = SPN_ABI_GNU, .driver = SPN_CC_DRIVER_GCC, .linker = SPN_LD_FAMILY_GNU, .mode = SPN_MODE_DEBUG, .opt = SPN_OPT_LEVEL_2 },
    .expect = { .defines = {
      "SPN_BUILD",
      "SPN_BUILD_OS_LINUX",
      "SPN_BUILD_ARCH_X86_64",
      "SPN_BUILD_ABI_GNU",
      "SPN_BUILD_DRIVER_GCC",
      "SPN_BUILD_LINKER_GNU",
      "SPN_BUILD_MODE_DEBUG",
      "SPN_BUILD_OPT_2",
    } },
  },
  {
    .name = "lld_linker",
    .facts = { .os = SPN_OS_LINUX, .arch = SPN_ARCH_X64, .abi = SPN_ABI_GNU, .driver = SPN_CC_DRIVER_GCC, .linker = SPN_LD_FAMILY_LLD, .mode = SPN_MODE_DEBUG, .opt = SPN_OPT_LEVEL_2 },
    .expect = { .defines = {
      "SPN_BUILD",
      "SPN_BUILD_OS_LINUX",
      "SPN_BUILD_ARCH_X86_64",
