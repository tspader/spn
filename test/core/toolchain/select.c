...
static const complete_test_t complete_tests [] = {
  ...
  {
    .name = "bare_rows_need_nothing_from_the_host",
    .driver = SPN_CC_DRIVER_GCC,
  ...
  {
    .name = "retargeting_driver_reaches_its_arch_bare",
    ...
    .checks = {
      ...
      { .target = ARM_LINUX, .abis = { SPN_ABI_BARE }, .expect = { .err = SPN_ERR_TOOLCHAIN_TARGET, .targets = { HOST_X64_LINUX, TARGET_X64_BARE, TARGET_X64_LINUX_NONE } } },
    },
  },
  {
  ...
  },
  {
    ...
    .targets = { HOST_X64_LINUX },
    .checks = {
      { .target = ARM_FREESTANDING, .abis = { SPN_ABI_ELF }, .expect = { .err = SPN_ERR_TOOLCHAIN_SYSROOT, .targets = { HOST_X64_LINUX, TARGET_X64_BARE, TARGET_X64_LINUX_NONE } } },
    },
  },
  {
  ...
  {
    .name = "retargeting_driver_needs_sysroot_off_host",
    .driver = SPN_CC_DRIVER_CLANG,
    .targets = { HOST_X64_LINUX },
    .checks = {
      { .target = ARM_LINUX, .abis = { SPN_ABI_GNU }, .expect = { .err = SPN_ERR_TOOLCHAIN_SYSROOT, .targets = { HOST_X64_LINUX, TARGET_X64_BARE, TARGET_X64_LINUX_NONE } } },
      { .target = X64_LINUX, .abis = { SPN_ABI_MUSL }, .expect = { .err = SPN_ERR_TOOLCHAIN_SYSROOT, .targets = { HOST_X64_LINUX, TARGET_X64_BARE, TARGET_X64_LINUX_NONE } } },
      { .target = X64_WINDOWS, .abis = { SPN_ABI_GNU }, .expect = { .err = SPN_ERR_TOOLCHAIN_SYSROOT, .targets = { HOST_X64_LINUX, TARGET_X64_BARE, TARGET_X64_LINUX_NONE } } },
    },
  },
  {
    .name = "retargeting_driver_needs_macos_sdk",
    .driver = SPN_CC_DRIVER_CLANG,
    .targets = { HOST_X64_LINUX },
    .checks = {
      { .target = ARM_MACOS, .abis = { SPN_ABI_APPLE }, .expect = { .err = SPN_ERR_TOOLCHAIN_SDK_MACOS, .targets = { HOST_X64_LINUX, TARGET_X64_BARE, TARGET_X64_LINUX_NONE } } },
    },
  },
  {
    .name = "retargeting_driver_needs_msvc_sdk",
    .driver = SPN_CC_DRIVER_ZIG,
    .targets = { { .triple = TARGET_WIN_GNU, .sdk_toolchain = true } },
    .checks = {
      { .target = X64_WINDOWS, .abis = { SPN_ABI_MSVC }, .expect = { .err = SPN_ERR_TOOLCHAIN_SDK_MSVC, .targets = { TARGET_WIN_GNU, HOST_X64_LINUX, TARGET_X64_BARE, TARGET_X64_LINUX_NONE } } },
    },
  },
  {
    .name = "unbuildable_abis_report_the_first",
    .driver = SPN_CC_DRIVER_CLANG,
    .targets = { HOST_X64_LINUX },
    .checks = {
      { .target = X64_WINDOWS, .abis = { SPN_ABI_MSVC, SPN_ABI_GNU }, .expect = { .err = SPN_ERR_TOOLCHAIN_SDK_MSVC, .targets = { HOST_X64_LINUX, TARGET_X64_BARE, TARGET_X64_LINUX_NONE } } },
      { .target = X64_WINDOWS, .abis = { SPN_ABI_GNU, SPN_ABI_MSVC }, .expect = { .err = SPN_ERR_TOOLCHAIN_SYSROOT, .targets = { HOST_X64_LINUX, TARGET_X64_BARE, TARGET_X64_LINUX_NONE } } },
    },
  },
  {
    .name = "no_abis_reports_first_os_abi",
    .driver = SPN_CC_DRIVER_CLANG,
    .targets = { HOST_X64_LINUX },
    .checks = {
      { .target = ARM_LINUX, .expect = { .err = SPN_ERR_TOOLCHAIN_SYSROOT, .targets = { HOST_X64_LINUX, TARGET_X64_BARE, TARGET_X64_LINUX_NONE } } },
    },
  },
  {
  ...
  },
  {
    ...
    .checks = {
      ...
      { .target = ARM_LINUX, .abis = { SPN_ABI_MUSL }, .expect = { .err = SPN_ERR_TOOLCHAIN_SYSROOT, .targets = { HOST_ARM_LINUX, HOST_X64_LINUX, TARGET_X64_BARE, TARGET_X64_LINUX_NONE } } },
    },
  },
  {
  ...
  },
  {
    ...
    .sdks = { .macos = { "/S" } },
    .checks = {
      { .target = ARM_MACOS, .abis = { SPN_ABI_APPLE }, .expect = { .triple = HOST_ARM_MACOS, .sdk = { SPN_SDK_MACOS, { "/S" } } } },
      { .target = X64_MACOS, .abis = { SPN_ABI_APPLE }, .expect = { .triple = HOST_X64_MACOS, .sdk = { SPN_SDK_MACOS, { "/S" } } } },
    },
  },
  {
  ...
  {
    .name = "unbuildable_abis_report_the_one_that_reached",
    .driver = SPN_CC_DRIVER_GCC,
    .targets = { { .triple = HOST_X64_LINUX, .sanitizers = SAN_GCC_LINUX } },
    .checks = {
      { .target = X64_LINUX, .abis = { SPN_ABI_MUSL, SPN_ABI_GNU }, .sanitizers = SPN_SANITIZER_MEMORY, .expect = { .err = SPN_ERR_SANITIZER_UNSUPPORTED, .triple = HOST_X64_LINUX, .unsupported = SPN_SANITIZER_MEMORY, .supported = SAN_GCC_LINUX } },
    },
  },
  {
    .name = "named_needs_declared_sanitizers",
    .driver = SPN_CC_DRIVER_ZIG,
    .targets = { { .triple = HOST_X64_LINUX, .sdk_toolchain = true, .sanitizers = SAN_ZIG_UT } },
    .checks = {
      { .target = X64_LINUX, .abis = { SPN_ABI_GNU }, .sanitizers = SPN_SANITIZER_UNDEFINED, .expect = { .triple = HOST_X64_LINUX } },
      { .target = X64_LINUX, .abis = { SPN_ABI_GNU }, .sanitizers = SPN_SANITIZER_ADDRESS, .expect = { .err = SPN_ERR_SANITIZER_UNSUPPORTED, .triple = HOST_X64_LINUX, .unsupported = SPN_SANITIZER_ADDRESS, .supported = SAN_ZIG_UT } },
    },
  },
  {
    .name = "sanitizers_pick_the_abi",
    .driver = SPN_CC_DRIVER_ZIG,
    .targets = {
      { .triple = TARGET_LINUX_MUSL, .sdk_toolchain = true, .sanitizers = SAN_ZIG_UT },
      { .triple = HOST_X64_LINUX, .sdk_toolchain = true, .sanitizers = SAN_ZIG_UT | SPN_SANITIZER_ADDRESS },
    },
    .checks = {
      { .target = X64_LINUX, .abis = { SPN_ABI_MUSL, SPN_ABI_GNU }, .sanitizers = SPN_SANITIZER_ADDRESS, .expect = { .triple = HOST_X64_LINUX } },
      { .target = X64_LINUX, .abis = { SPN_ABI_MUSL, SPN_ABI_GNU }, .sanitizers = SPN_SANITIZER_MEMORY, .expect = { .err = SPN_ERR_SANITIZER_UNSUPPORTED, .triple = TARGET_LINUX_MUSL, .unsupported = SPN_SANITIZER_MEMORY, .supported = SAN_ZIG_UT } },
    },
  },
  {
    .name = "heavy_sanitizers_need_dynamic_linkage",
    .driver = SPN_CC_DRIVER_GCC,
    .targets = {
      { .triple = HOST_X64_LINUX, .sanitizers = SAN_GCC_LINUX },
      { .triple = TARGET_LINUX_MUSL, .sdk_toolchain = true, .sanitizers = SAN_GCC_LINUX },
    },
    .checks = {
      { .target = X64_LINUX, .abis = { SPN_ABI_MUSL, SPN_ABI_GNU }, .sanitizers = SPN_SANITIZER_ADDRESS, .expect = { .triple = HOST_X64_LINUX } },
...
static const resolve_test_t resolve_tests [] = {
  ...
  },
  {
    ...
    .abis = { SPN_ABI_APPLE },
    .sdks = { .macos = { "/S" } },
    .expect = { .name = "B", .triple = HOST_ARM_MACOS, .sdk = { SPN_SDK_MACOS, { "/S" } } },
  },
  {
  ...
  },
  {
    ...
    .file = "auto.json",
    .target = { SPN_ARCH_ARM64, SPN_OS_WINDOWS },
    .expect = { .err = SPN_ERR_TOOLCHAIN_NONE },
  },
  {
    .name = "auto_skips_toolchains_without_sanitizers",
    .file = "auto.json",
    .target = X64_LINUX,
    .abis = { SPN_ABI_GNU },
    .sanitizers = SPN_SANITIZER_ADDRESS,
    .expect = { .name = "D", .triple = HOST_X64_LINUX },
  },
  {
    .name = "auto_with_no_sanitizer_support_finds_none",
    .file = "auto.json",
    .target = X64_LINUX,
    .abis = { SPN_ABI_GNU },
  ...
  {
    .name = "windows_host_reaches_derived_gnu_row",
    .file = "drivers.json",
    .toolchain = "A",
    .target = X64_WINDOWS,
    .abis = { SPN_ABI_GNU },
  ...
  },
  {
    ...
    .host = HOST_ARM_MACOS,
    .sdks = { .macos = { "/S" } },
    .expect = { .name = "B", .triple = HOST_X64_MACOS, .sdk = { SPN_SDK_MACOS, { "/S" } } },
  },
  {
  ...
  {
    .name = "sysroot_error_lists_capable_toolchains",
    .file = "auto.json",
    .toolchain = "B",
    .target = X64_WINDOWS,
    .abis = { SPN_ABI_GNU },
    .expect = { .err = SPN_ERR_TOOLCHAIN_SYSROOT, .targets = { HOST_X64_LINUX, TARGET_LINUX_MUSL, HOST_ARM_LINUX, TARGET_ARM_LINUX_MUSL, TARGET_X64_BARE, TARGET_X64_LINUX_NONE }, .candidates = { "A", "C" } },
  },
  {
