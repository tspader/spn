...
static const test_t tests [] = {
  {
    ...
    .expect = {
      ...
      .targets = {
        ...
        { .triple = { SPN_ARCH_X64, SPN_OS_LINUX, SPN_ABI_GNU }, .sdk_toolchain = true, .sanitizers = SAN_ZIG_UT },
        { .triple = { SPN_ARCH_X64, SPN_OS_LINUX, SPN_ABI_MUSL }, .sdk_toolchain = true, .sanitizers = SAN_ZIG_UT },
        { .triple = { SPN_ARCH_ARM64, SPN_OS_LINUX, SPN_ABI_GNU }, .sdk_toolchain = true, .sanitizers = SAN_ZIG_UT },
        { .triple = { SPN_ARCH_ARM64, SPN_OS_LINUX, SPN_ABI_MUSL }, .sdk_toolchain = true, .sanitizers = SAN_ZIG_UT },
        { .triple = { SPN_ARCH_X64, SPN_OS_MACOS, SPN_ABI_APPLE }, .sdk_toolchain = true, .sanitizers = SAN_ZIG_UT },
        { .triple = { SPN_ARCH_ARM64, SPN_OS_MACOS, SPN_ABI_APPLE }, .sdk_toolchain = true, .sanitizers = SAN_ZIG_UT },
        { .triple = { SPN_ARCH_X64, SPN_OS_WINDOWS, SPN_ABI_GNU }, .sdk_toolchain = true, .sanitizers = SAN_ZIG_U },
        { .triple = { SPN_ARCH_ARM64, SPN_OS_WINDOWS, SPN_ABI_GNU }, .sdk_toolchain = true, .sanitizers = SAN_ZIG_U },
        { .triple = { SPN_ARCH_X64, SPN_OS_WINDOWS, SPN_ABI_MSVC }, .sanitizers = SAN_ZIG_U },
        { .triple = { SPN_ARCH_ARM64, SPN_OS_WINDOWS, SPN_ABI_MSVC }, .sanitizers = SAN_ZIG_U },
        { .triple = { SPN_ARCH_X64, SPN_OS_FREESTANDING, SPN_ABI_BARE } },
        { .triple = { SPN_ARCH_ARM64, SPN_OS_FREESTANDING, SPN_ABI_BARE } },
        { .triple = { SPN_ARCH_X64, SPN_OS_LINUX, SPN_ABI_BARE } },
        { .triple = { SPN_ARCH_ARM64, SPN_OS_LINUX, SPN_ABI_BARE } },
      },
    },
  },
  {
    ...
    .expect = {
      ...
      .targets = {
        { .triple = { SPN_ARCH_X64, SPN_OS_WINDOWS, SPN_ABI_MSVC }, .sanitizers = SPN_SANITIZER_ADDRESS },
        { .triple = { SPN_ARCH_ARM64, SPN_OS_WINDOWS, SPN_ABI_MSVC } },
      },
    },
  },
  {
...
static const bind_test_t bind_tests [] = {
  {
    ...
    .toolchain = "clang",
    .host = HOST_X64_LINUX,
    .expect = { .targets = { { .triple = HOST_X64_LINUX, .sanitizers = SAN_CLANG_LINUX }, TARGET_X64_BARE, TARGET_X64_LINUX_NONE } },
  },
  {
    .name = "gcc_on_linux",
    .toolchain = "gcc",
    .host = HOST_X64_LINUX,
    .expect = { .targets = { { .triple = HOST_X64_LINUX, .sanitizers = SAN_GCC_LINUX }, TARGET_X64_BARE, TARGET_X64_LINUX_NONE } },
  },
  {
