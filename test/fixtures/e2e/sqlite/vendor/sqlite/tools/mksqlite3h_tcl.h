/* Auto-generated from mksqlite3h.tcl (patched: no exec, spn_pump). Do not edit. */
static const char SPN_MKSQLITE3H_TCL[] =
  ...
  "\n"
  "    if {$useapicall} {\n"
  "      # spn: under -useapicall every line with \"(*\" is rewritten, so the\n"
  "      # pump's pass-through would be wrong; keep the plain loop.\n"
  "      if {[eof $in]} break\n"
  "      set line [string trimright [gets $in]]\n"
  "    } else {\n"
  "      # spn: spn_pump (native, see jimsh0.c) trims and copies lines that\n"
  "      # cannot match any pattern below straight to $out and returns only\n"
  "      # lines containing \"sqlite3\" or \"--\".\n"
  "      set pumped [spn_pump $in $out sqlite3h]\n"
