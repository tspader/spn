...
const c8* spn_err_to_str(spn_err_t err) {
  switch (err) {
    ...
    case SPN_ERR_CODEGEN_EXPECTED_BOOL:        return "codegen_expected_bool";
    case SPN_ERR_CODEGEN_EXPECTED_STR:         return "codegen_expected_str";
    case SPN_ERR_CODEGEN_EXPECTED_INT:         return "codegen_expected_int";
    case SPN_ERR_CODEGEN_EXPECTED_OBJECT:      return "codegen_expected_object";
    case SPN_ERR_CODEGEN_MISSING_KEY:          return "codegen_missing_key";
    case SPN_ERR_CODEGEN_DUPLICATE_KEY:        return "codegen_duplicate_key";
    case SPN_ERR_CODEGEN_UNKNOWN_KEY:          return "codegen_unknown_key";
    case SPN_ERR_CODEGEN_PARSE:                return "codegen_parse";
    case SPN_ERR_CODEGEN_FILE_MISSING:         return "codegen_file_missing";
    case SPN_ERR_CODEGEN_INVALID:              return "codegen_invalid";
    case SPN_ERR_CODEGEN_ROOT_ONLY:            return "codegen_root_only";
