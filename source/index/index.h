...
spn_index_pkg_t* spn_index_get_package(spn_index_t* index, spn_pkg_id_t pkg);
spn_index_rel_t* spn_index_get_release(spn_index_t* index, spn_pkg_id_t pkg, spn_semver_t version);
