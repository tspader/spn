...
#define CONTAINER_SHELL_BIN "smoke-shell"
#define CONTAINER_CHECK_BIN "smoke-check"

#define CONTAINER_SPN CONTAINER_SPN_DIR "/spn"
#define CONTAINER_SHELL CONTAINER_TOOL_DIR "/" CONTAINER_SHELL_BIN
#define CONTAINER_CHECK CONTAINER_TOOL_DIR "/" CONTAINER_CHECK_BIN
