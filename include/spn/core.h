...
typedef enum {
  ...
  SPN_ERR_TOOLCHAIN_SCRIPT_TARGET,
  ...
  SPN_ERR_PKG_CONFLICT,
  SPN_ERR_PKG_CONFLICT_EXACT,
  ...
  SPN_ERR_OPTION_UNDECLARED,
  SPN_ERR_OPTION_BAD_VALUE,
  SPN_ERR_OPTION_CONFLICT,
  SPN_ERR_OPTION_VETO,
  SPN_ERR_OPTION_NO_VALUE,
  SPN_ERR_OPTION_LATE_GATE,
  SPN_ERR_OPTION_UNKNOWN_PKG,
  SPN_ERR_CONFIGURE_SOURCE_GLOB,
  SPN_ERR_CONFIGURE_SOURCE_MISSING,
  SPN_ERR_INIT_EXISTS,
  SPN_ERR_INIT_NAME,
  SPN_ERR_SCAFFOLD_TEMPLATE,
  SPN_ERR_TEST_MISSING,
  SPN_ERR_TEST_FAILED,
  SPN_ERR_VERSION_INVALID,
  SPN_ERR_CANCELLED,
  SPN_ERR_PATCH_UNUSED,
  SPN_ERR_PATCH_NOT_GIT,
  SPN_ERR_HEADER_COLLISION,
  SPN_ERR_COUNT,
} spn_err_t;
...
typedef enum {
  ...
  SPN_EVENT_SYNC_END,
  SPN_EVENT_SCRIPT_COMPILE,
  SPN_EVENT_SCRIPT_COMPILE_FAILED,
  SPN_EVENT_CONFIGURE,
  SPN_EVENT_CONFIGURE_OK,
  SPN_EVENT_SCRIPT_PACKAGE,
  SPN_EVENT_PACKAGE_OK,
  SPN_EVENT_SCRIPT_CRASHED,
  SPN_EVENT_SCRIPT_USER_FN,
