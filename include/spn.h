...
const c8*         spn_pkg_get_dir(spn_build_ctx_t* b, const c8* name, spn_dir_kind_t kind);
...
void              spn_target_embed_dir_ex(spn_target_t* target, const c8* file, const c8* data_type, const c8* size_type);
