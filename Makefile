...
SPN_SOURCE_FILES := $(SPN_DIR_SOURCE)/main.c $(SPN_DIR_ARGPARSE)/argparse.c
...
$(SPN_OUTPUT): $(SPN_SOURCE_FILES) $(SPN_DIR_BUILD_OUTPUT) $(SDL_OUTPUT)
...
.PHONY: build clangd sdl run clean
