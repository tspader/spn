...
SPN_TEST_SOURCE_FILES := $(SPN_DIR_TEST)/test.c
SPN_CLANGD_HEADER_ONLY_BULLSHIT := -DSP_OS_BACKEND_SDL, -DSP_IMPLEMENTATION, -DSPN_IMPLEMENTATION, -include, toml/toml.h, -include, argparse/argparse.h, -include, sp/sp.h, -include SDL3/SDL.h
...
$(SPN_TEST_BINARY): $(SPN_TEST_SOURCE_FILES) $(SPN_SP_H) $(SPN_DIR_BUILD_OUTPUT) $(SDL_BINARY)
	$(CC) $(SPN_TEST_CC_FLAGS) $(SPN_TEST_SOURCE_FILES)
